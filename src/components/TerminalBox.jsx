...
const TOKENS = [
  ...
  { t: '. A pesar de que hoy ya no me encuentre trabajando en el mismo lugar si recuerdo ', c: 'text-white/85' },
  { t: 'nuestras aventuras', c: 'text-neon-pink' },
  { t: ', ', c: 'text-white/85' },
  { t: 'nuestras locuras', c: 'text-neon-magenta' },
  { t: ' y te agradezco  por haberme brindado tu amistad, sé que ', c: 'text-white/85' },
  { t: 'vas a llegar muy lejos', c: 'text-neon-magenta' },
  { t: ' no importa que problema se anteponga ', c: 'text-white/85' },
  { t: 'veo un gran futuro para ti', c: 'text-neon-pink' },
  { t: '. quería darte esta ', c: 'text-white/85' },
